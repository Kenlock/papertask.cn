			        ...
			        <div class="tab-pane fade in active " id="signup">
			            ...
			            <form role="form" id="signup_form" class="signup_form">
			                ...
			                <div class="form-group">
			                	<div class="row">
			                    	<div class="col-md-4">
			                        	<label class="control-label title-plan" for="register_phone"><?php _e('Mobile Phone', ET_DOMAIN) ?><span><?php _e('Enter mobile phone', ET_DOMAIN) ?></span></label>
			                        </div>
			                        <div class="col-sm-8">
			                            <input type="number" class="form-control  text-field" id="register_phone" name="phone" placeholder="<?php _e("Your mobile phone", ET_DOMAIN); ?>">
			                        </div>
			                    </div>
			                </div>
                            <div class="clearfix"></div>
