...
<?php
	...
	if(is_page_template( 'page-profile.php' ) || (isset($PAGE_PORTFOLIO) && $PAGE_PORTFOLIO == true)) {
    	/* ======= modal add portfolio template ======= */
    	get_template_part( 'template-js/modal' , 'add-portfolio' );
    	get_template_part( 'template-js/modal' , 'add-verification' );
