		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" id="signup_form" class="auth-form signup_form">
                	<p class="user-type">
                		<span class="user-text" style="color: red;"><?php _e("What are you looking for?", ET_DOMAIN) ?></span>
					...
					<div class="form-group">
						<label for="register_phone"><?php _e('Phone Number', ET_DOMAIN) ?></label>
						<input type="number" class="form-control" id="register_phone" name="phone" placeholder="<?php _e("Enter Phone", ET_DOMAIN) ?>">
					</div>
					<div class="form-group">
