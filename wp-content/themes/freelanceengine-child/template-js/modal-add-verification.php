		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form role="form" id="create_verification" class="auth-form create_verification">
                	<div id="verification_img_container" style="height: 235px; max-height: 235px;">
                		...
                		<p class="browser-image">
                			<input type="button" id="verification_img_browse_button" class="btn btn-default btn-submit btn-browse" value="<?php _e('Browse', ET_DOMAIN); ?>" />
                		</p>
                	</div>
                	<div class="clearfix"></div>
                	<div class="form-group">
                		<label><?php _e('ID Type', ET_DOMAIN) ?></label>
                		<p><input type="text" name="post_title" id="post_title" placeholder="<?php _e('Identification Card or Passport', ET_DOMAIN) ?>" /></p>
                	</div>
					<div class="clearfix"></div>
                	<div class="form-group">
					...
					<button type="submit" class="btn-submit btn-sumary btn-sub-create btn-add-verification">
