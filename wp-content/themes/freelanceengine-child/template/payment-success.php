...
*/
global $ad, $payment_return,$payment_type_alipay,$project_id;
if($payment_return)
...
<div class="redirect-content" style="overflow:hidden" >
	...
	<?php
	if($payment_type_alipay):
			printf(__("Your payment has been sent successfully. Thank you for your trusting PaperTask.com. Our Translator will start your job now.", ET_DOMAIN), "CLose");
	?>
	<br/>
	...
	<?php //echo '<a href="'.$permalink.'" >'.get_the_title( $project_id ).'</a>'; ?>
