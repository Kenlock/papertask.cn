...
<li class="bid-item">
    ...
    <ul class="info-history">
        <li><?php echo $current->post_date; ?></li>
        <?PHP if((float) $convert->et_budget) { ?>
		<li>
            <?php _e("Budget", ET_DOMAIN); ?> :
            <span class="number-price-project-info"><?php echo $convert->bid_budget_text; ?></span>
        </li>
		<?PHP } ?>
