    ...
    <div class="row">
        <div class="col-md-8 col-xs-12 report-container">
            <div class="report-attention">
                ...
                <h3 class="report-decision">
                    <?php _e('Report and Decision',ET_DOMAIN) ?>
                </h3>
            </div>
        	<div class="work-report-wrapper">
                	...
                	<form class="form-group-work-place-wrapper form-report notify-mail">
                    	<div class="form-group-work-place work-place-dispute" id="report_docs_container">
                            ...
                            <div class="content-report-wrapper">
                            	<div class="text-your-report"><?php _e("Your report", ET_DOMAIN); ?></div>
                                <div class="form-group field-style-textarea">
                            ...
                            <div class="file-attachment-wrapper">
                                <div class="title-attachment"><?php _e("Report Attachments:", ET_DOMAIN); ?></div>
                                <a href="#" class="attach-file-button" id="report_docs_browse_button">
                                    <i class="fa fa-plus-circle"></i><?php _e("Attach related file", ET_DOMAIN); ?>
                                </a>
                            ...
                            <div class="button-send-report">
                                <?php if(et_load_mobile()) { ?>
                                    <input type="submit" name="submit" value="<?php _e( "Submit" , ET_DOMAIN ); ?>" class="submit-chat-content">
                                <?php } ?>
                            </div>
                        </div>
                ...
                <ul class="list-chat-work-place list-chat-work-place-dispute">
                    <?php 
                ...
                <?php if(et_load_mobile()) { ?>
                    ...
                    if(current_user_can( 'manage_options' ) && ae_get_option('use_escrow') && $post->post_status == 'disputing') { ?>
                        <form class="transfer-escrow">
                            <div class="text-transfer-escrow"><?php _e("Escrow transfer to", ET_DOMAIN); ?></div>
                            <div class="form-group">
                                <select class="transfer-select">
                                    <option value="freelancer"><?php _e("Freelancer", ET_DOMAIN); ?></option>
                                    <option value="employer"><?php _e("Employer", ET_DOMAIN); ?></option>
        ...
        <div class="col-md-4 col-xs-12 workplace-project-details">
        	<div class="content-require-project">
                ...
                if(fre_access_workspace($post)) {
                    ...
                    echo '<a class="workspace-link" style="font-weight:600;" href="'.add_query_arg(array('workspace' => 1), $project_link).'">'
