...
<body <?php body_class( 'cbp-spmenu-push is-mobile' ); ?>>
    ...
    <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right" id="cbp-spmenu-s2">
        <ul class="list-info-user-nav">
            ...
            <?php if( ae_user_role($user_ID) == FREELANCER || ae_user_role($user_ID) == FREELANCER_VERIFIED ){
            ...
            <?php //} ?>
            <?php if( fre_share_role() || ae_user_role($current_user->ID) == FREELANCER || ae_user_role($user_ID) == FREELANCER_VERIFIED){ ?>
            <li>
