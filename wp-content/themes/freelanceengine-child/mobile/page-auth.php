...
<section class="section-wrapper section-register">
    <form class="form-mobile-wrapper signup_form">
    	...
    	<div class="form-group-mobile">
        	<span class="icon-form-login fa fa-user fa-2x"></span>
        	<input type="text" id="user_login" name="user_login" placeholder="<?php _e("Username", ET_DOMAIN); ?>">
        </div>
        <div class="form-group-mobile">
        	<span class="icon-form-login fa fa-envelope fa-2x"></span>
        	<input type="email" id="user_email" name="user_email" placeholder="<?php _e("Your Email", ET_DOMAIN); ?>">
        </div>
        <div class="form-group-mobile">
            <span class="icon-form-login fa fa-phone fa-2x"></span>
            <input type="text" id="register_phone" name="phone" placeholder="<?php _e("Your Mobile Phone", ET_DOMAIN); ?>">
        </div>


        <div class="form-group-mobile">
        	<span class="icon-form-login fa fa-key fa-2x"></span>
