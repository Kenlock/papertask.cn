...
?>
    ...
    <div class="content-project-wrapper">
        ...
        <!-- end form bid !-->
    	<h2 style="font-size: 18px;" class="title-content"><?php _e('Project description:',ET_DOMAIN);?></h2>
        <?php
            the_content();
        ...
        <style type="text/css">
            .content-project-wrapper .title-content {
                font-size: 18px;
            }
        </style>
        ...
        <?php
            ...
            if($sourcetext && $sourcetext[0]!='')
            {
                ...
                echo '<h3 style="font-size: 18px;" class="title-content">'. __("Source Text:", ET_DOMAIN) .'</h3>'
                .$sourcetext[0];
            }
             else
            {
                ...
                if(!empty($attachment)) {
                    ...
                    echo '<h3 style="font-size: 18px;" class="title-content">'. __("Source Attachments:", ET_DOMAIN) .'</h3>';
