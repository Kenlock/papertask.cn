    ...
    */
        ...
        initialize: function(options) {
            ...
            this.config = {
                ...
                filters: {
                    mime_types: [{
                        title: 'Image Files',
                        extensions: 'txt,gif,jpeg,jpg,png,doc,docx,ppt,pptx,pdf,chm,xls,xlsx,ico,zip,rar'//(this.options.extensions) ? this.options.extensions : 'pdf,jpg,jpeg,gif,png,ico'
                    }]
                },
                multipart_params: {
    ...
    Views.Skill_Control = Backbone.View.extend({
        ...
        addSkill: function(skill) {
			...
			if($("form#profile_form") && $("form#profile_form input[name=skill]").length > 0) {
				$("form#profile_form input[name=skill]").rules( "add", {
					required: ($("form#profile_form ul.skills-list li.skill-item").length === 0)
				});
			}
        },
    ...
    Views.Carousel = Backbone.View.extend({
        ...
        setupView: function() {
            ...
            if (typeof this.carousel_uploader === 'undefined') this.carousel_uploader = new Views.File_Uploader({
                el: $carousel,
                extensions : 'txt,gif,jpeg,jpg,png,doc,docx,ppt,pptx,pdf,chm,xls,xlsx,ico,zip,rar',//(this.options.extensions) ? this.options.extensions : 'txt,gif,jpeg,jpg,png,doc,docx,pt,pptx,pdf,chm,xls,xlsx,ico',
                uploaderID: 'carousel',
                thumbsize: 'thumbnail',
                ...
                filters: [{
                    title: 'Image Files',
                    extensions : 'txt,gif,jpeg,jpg,png,doc,docx,ppt,pptx,pdf,chm,xls,xlsx,ico,zip,rar'//(this.options.extensions) ? this.options.extensions : 'jpg,jpeg,gif,png,ico'
                }],
