...
class AppEngine extends AE_Base
{
    ...
    public function print_scripts() {
        ...
        $this->register_script('et-googlemap-api', '//maps.googleapis.com/maps/api/js?signed_in=false', '3.0', true);
        ...
        if(ae_get_option('gg_captcha', false) && !current_user_can('manage_options')){
