    ...
    */
    function fre_check_before_insert_bid($args) {
        ...
        */
        ...
        $role = ae_user_role();
        if (!fre_share_role() && $role != FREELANCER && $role != "FREELANCER_VERIFIED") return new WP_Error(200, __('You have to be a freelancer to bid a project.', ET_DOMAIN));
    ...
    function assign_project($bid_id) {
      ...
      //ini_set('display_errors', 1);
        ...
        if ((int)$project->post_author == $user_ID) {
            ...
            //var_dump((float)get_post_meta($bid_id, 'bid_budget', true));exit;
			...
			update_post_meta($project->ID, "et_budget", (float)get_post_meta($bid_id, 'bid_budget', true));
