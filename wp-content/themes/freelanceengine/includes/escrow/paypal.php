...
function fre_enqueue_escrow() {
  $role = ae_user_role();
    if (is_singular(PROJECT) && $role != EMPLOYER-VIP) {
...
function ae_ppadaptive_recipient_field(){
    ...
    <div class="form-group">
        <div class="form-group-control">
            ...
            <input type="email" class="form-control" id="paypal" name="paypal" value="<?php echo get_user_meta( $uid, 'paypal', true ); ?>" placeholder="<?php _e('Enter your paypal email', ET_DOMAIN) ?>">
        </div>
    </div>
...
<?php
    ...
    <div class="form-group-mobile">
        <label><?php _e('Your Paypal Account', ET_DOMAIN) ?></label>
        <input type="email" id="paypal" value="<?php echo get_user_meta( $uid, 'paypal', true ); ?>" name="paypal" placeholder="<?php _e('Enter your paypal email', ET_DOMAIN) ?>">
    </div>
<?php }
        $html = ob_get_clean();
